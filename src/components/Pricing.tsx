...
const handleRedirect = () => {
  ...
  const dynamicPlans = [
    {
      name: "Basic Dynamic",
      description: "Simple database-powered functionality.",
      price: "$220",
      period: "(one-time)",
      features: [
        "Up to 5 dynamic pages",
        "Contact Form (DB Connected)",
    ...
    },
    {
      ...
      description: "For businesses needing user management.",
      price: "$320",
      period: "(one-time)",
      features: [
        "8-10 dynamic pages",
  ...
  return (
    <section id="pricing" className="py-10 md:py-20 bg-black dot-bg relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <div className="inline-flex bg-gray-900/50 border border-white/10 rounded-full px-4 py-2 mb-6">
            <span className="text-white/80 text-sm">Simple & Transparent</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
